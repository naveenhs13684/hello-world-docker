...
<head>
    ...
    <meta name="author" content="Naveen Kumar HS">
...
<body  onload="updateVisit(); updateClock(); setInterval('updateClock()', 1000 )">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="https://github.com/naveenhs13684/hello-world-docker">About</a></li>
            <li><a href="www.linkedin.com/in/naveen-kumar-hs-b80a4175/">Contact</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <hr/>
      <div class="footer">
        <p>2023 - DevOps Manager - Naveen Kumar HS,&nbsp;Visits:&nbsp;<span id="visits">&nbsp;</span>,&nbsp;&nbsp;<span id="clock">&nbsp;</span></p>
